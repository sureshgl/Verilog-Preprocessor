...
public class SetExtendedContextVisitorGenerator {
	...
	private static void generateTestClasses(Map<String, RuleType> rules) throws FileNotFoundException {
		...
		sb.append("public class SetExtendedContextVisitor extends PPParserBaseVisitor<ParserRuleContext>{\n");
		...
		sb.append("}");
		FileUtils.WriteFile(new File("tools/com.proteus.preprocess/pp/SetExtendedContextVisitor.java"), sb);
