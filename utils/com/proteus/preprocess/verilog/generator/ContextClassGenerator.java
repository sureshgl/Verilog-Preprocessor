...
public class ContextClassGenerator {
	...
	private static void generateTestClasses(Map<String, RuleType> rules) throws FileNotFoundException {
		...
		STGroupFile stgf = new STGroupFile("templates/verilogprime/ClassContext.stg");
		...
		for(Entry<String, RuleType> e:rules.entrySet()){
			if(! e.getValue().isAlt()){
				...
				FileUtils.WriteFile(new File("src/com.proteus.verilog/verilogprime/ext/"+classname+"Ext.java"), st.render());
	...
	public static void main(String[] args) throws IOException {
		generateTestClasses(Antlr4Reflection.getParserRules("grammar/VerilogPrime.g4"));
	}
