...
import com.proteus.preprocess.ANTLRv4.gen.ANTLRv4Parser.AlternativeContext;
import com.proteus.preprocess.ANTLRv4.gen.ANTLRv4Parser.ElementContext;
...
public class StringLiteralsToLexers extends ANTLRv4ParserBaseVisitor<String>{
	...
	public static void main(String args[]) throws IOException{
		...
		for(String literal:stringLiteralsToLexers.literals){
			...
			stringLiteralsToLexers.temp.append("locals [ "+literal+"strContextExt extendedContext ]\n");
